<template>
  <DemoSection>
    ...
    <DemoBlock card :title="position">
      ...
      <van-cell :title="buttonRight" is-link @click="showRight = true" @close="showRight = false" />

      <glue-popup :show="showTop" position="top" width="100%" height="30%" @close="showTop = false" />
